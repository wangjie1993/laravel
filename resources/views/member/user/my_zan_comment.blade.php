                                                    ...
                                                    <div class="col ml--2">
                                                        ...
                                                        <p class="card-text small mb-1">
                                                            <a href="{{route('member.user.show',$zan->belongsModel->user)}}" class="text-secondary mr-2">
                                                                ...
                                                                {{$zan->belongsModel->user->name}}
                                                            </a>

                                                            <i class="fa fa-clock-o" aria-hidden="true"></i>
                                                            {{$zan->belongsModel->created_at->diffForHumans()}}


                                                        </p>

                                                    </div>
                                                    <a href="{{route('home.zan.make',['type'=>'comment','id'=>$zan->belongsModel->id])}}">取消赞</a>
                                                </div> <!-- / .row -->
